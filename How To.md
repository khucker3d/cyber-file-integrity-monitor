...
6. When the tool reports a modification (file change, file addition, or file deletion, the changes will appear in red text.
...
7. Review the event log and report using the correct escalation protocol
8. Once approved, choose the instructed response Action:
   ...
   **Actions:**
   * **Approve Changes:** Only approve changes through written authorization. 
   * **Revert Data:** This will revert all changes to the baseline
